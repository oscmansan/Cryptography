...
f1 = int(signature[_sage_const_8 :_sage_const_8 +_sage_const_66 ],_sage_const_16 )
f2 = int(signature[-_sage_const_66 :],_sage_const_16 )
print 'f1:', signature[_sage_const_8 :_sage_const_8 +_sage_const_66 ]
print 'f2:', signature[-_sage_const_66 :]
sha_hash = _sage_const_0x527baf231fec3b2c72fbfa663116ec6fc6366fcad958b884db63919a9344a19f 
G = E(Gx,Gy)
q = G.order()
